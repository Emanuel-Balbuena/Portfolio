...
* [ ] **En progreso:** Construcción de la Interfaz Técnica para PowerLink (`PowerLinkDetail`). Integración de un diagrama de arquitectura interactivo utilizando primitivas de shadcn/ui (`HoverCard`, `Tabs`) para alternar entre flujos de Hardware y Software, e resaltador de sintaxis para los bloques de código.